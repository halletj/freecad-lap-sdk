...
DEFAULT_GOTCHAS = [
    "ALWAYS call doc.recompute() after modifying objects -- nothing updates without it. Use doc.recompute(), NOT obj.recompute() on individual features -- feature-level recompute skips dependency resolution and causes stale state",
